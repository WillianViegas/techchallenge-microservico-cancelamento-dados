...
namespace tech_ms_cancelamento_dados_test.Controllers
{
    public class SolicitacaoControllerTests
    {
        ...
        public void GetAllSolicitacoes()
        {
            ...
            var controller = ConfigMockSolicitacaoController(solicitacaoService);
           ...
           .ReturnsAsync(solicitacaoList);
            ...
            //act
            var result = controller.GetAllSolicitacoes();
        ...
        public void GetSolicitacaoById()
        {
           ...
           .ReturnsAsync(solicitacao1);
            ...
            //act
            var result = controller.GetSolicitacaoById(solicitacao1.Id);
        ...
        public void SalvarSolicitacao()
        {
           ...
           .Setup(service => service.SaveSolicitacao(solicitacao1)).Verifiable();
            ...
            //act
            var result = controller.SalvarSolicitacao(solicitacao1);
